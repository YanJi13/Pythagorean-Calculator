...
using namespace std;
    ...
    do {
        ...
        cout << "Pythagorean Theorem Calculator v3.2\n\n"; // Project title and current version
        ...
        cout << "input: ";
            // input validation in main menu, program goes crazy if char data  type is used as input, dont know why
        if(!(cin >> menuOptions)){
            cin.clear();
            cin.ignore(123, '\n');
                }
            ...
            switch(menuOptions){
                case 1: // Patch notes
                    cout << "v1.0 - Full functionality with 3 modes based on which side user is looking for.\n"
                            ...
                            "v3.2 - Added input validation in the main menu input, and improved functions that check for invalid inputs, \n"
